...
for mod_key in list(sys.modules.keys()):
    if mod_key in ("agents.mcp_client", "agents.mcp_connection_manager") or \
       mod_key.startswith("agents.mcp_client.") or mod_key.startswith("agents.mcp_connection_manager."):
