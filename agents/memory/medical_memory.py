...
class MedicalMemory:
    ...
    def check_allergies(self, user_id: str) -> str:
        ...
        return self.recall_medical(user_id, "allergies medications adverse reactions", category="allergy", limit=10)

    def check_medications(self, user_id: str) -> str:
        """Recall current medications for a patient."""
        return self.recall_medical(user_id, "current medications prescriptions", category="medication", limit=10)
